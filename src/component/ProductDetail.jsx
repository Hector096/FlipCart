...
import { Card, Image,Button, Modal, Form, Input, InputNumber } from 'antd';
...
.catch(() => {
  ...
  return (
    ...
    actions={[
      <div className='p-2'> <Button type='primary' block size='large' onClick={()=>{setVisible(true)}}>Buy</Button></div>
      ,
    ]}
    >
    <Meta
